...
from dss_toolkit.clean.missing import _missing_vals

from dss_toolkit.base.input_validation import _validate_input_bool
from dss_toolkit.base.input_validation import _validate_input_int
from dss_toolkit.base.input_validation import _validate_input_range
from dss_toolkit.base.input_validation import _validate_input_smaller
from dss_toolkit.base.input_validation import _validate_input_sum_larger
...
def dist_plot(
    ...
    kde_kws = {"alpha": 0.75, "linewidth": 1.5, "bw_adjust": 0.8} if kde_kws is None else kde_kws.copy()
    rug_kws = {"color": "#ff3333", "alpha": 0.15, "lw": 3, "height": 0.075} if rug_kws is None else rug_kws.copy()
    ...
    for col in cols:
        ...
        g.axes[0, 0].fill_between(
            x,
            y,
            where=((x >= np.quantile(col_df, fill_range[0])) & (x <= np.quantile(col_df, fill_range[1]))),
